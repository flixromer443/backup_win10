        ...
        while(!feof($archivo2)){
            ...
            if($ref2==$id){
                ...
                <tr>
                        ...
                        <div class='modal-dialog modal-dialog-centered' role='document'>
                          <div class='modal-content'>
                            <div class='modal-header'>
                              <h5 class='modal-title' id='exampleModalLongTitle'>Elimin&aacute;r</h5>
                              <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                                <span aria-hidden='true'>&times;</span>
                              </button>
                            </div>
                            <div class='modal-body'>
                              Se eliminar&aacute;n todos los datos incluyendo los datos de facturaci&oacute;n.
                            </div>
                            <div class='modal-footer'>
                              <button type='button' class='btn btn-secondary' data-dismiss='modal'>Cerrar</button>
                              <button type='button' class='btn btn-danger'>Elimin&aacute;r</button>
                            </div>
                          </div>
                        </div>
                      </div>";
                 echo "
                 <td>
                 <a href='../interfaces/editar.php?id=$id'>
